...
class SnakeGame:
    def __init__(self, w=640, h=480, capture_area=(0, 0, 640, 480)):
        self.w = w
        self.h = h
...
if __name__ == '__main__':
    capture_area = (50, 50, 690, 530)  # Adjust the capture area as needed
    game = SnakeGame(capture_area=capture_area)
